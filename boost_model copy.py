...
for round_num in range(5):
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig(f"boost_demographic_parity_round_{round_num}.png")
    plt.close()
    ...
    pred_df.to_csv(f"boost_predicted_probs_round_{round_num}.csv", index=False)
...
summary_df.to_csv("boost_shock_summary_results.csv", index=False)
print("\nAll shock round results saved. Check 'boost_shock_summary_results.csv' and plots.")
